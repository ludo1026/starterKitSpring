/*
 * Created on 22 nov. 2013 ( Date ISO 2013-11-22 - Time 17:26:02 )
...
public class JpaEnvironment {
	...
	public static final Logger LOG = Logger.getLogger(JpaEnvironment.class);
			...
			try {
				...
				if(e.getCause() != null && e.getCause() instanceof SQLException) {
					...
					if(sqlException.getNextException() != null) {
						LOG.error(sqlException.getNextException());
					}
				}
				throw e;
			} finally {
