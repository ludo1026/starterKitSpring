...
<head>
	...
	<title>SynopsisStore</title>
		...
		var urlBase = '<c:url value="/synopsis" />';
...
<body>
	...
	<div class="container">
			<table class="table table-bordered">
				...
				<tbody>
					<c:forEach items="${listSynopsiss}" var="synopsis">
						<tr>
							<td>${synopsis.bookId}</td>
							<td>${synopsis.synopsis}</td>
							<c:url var="editSynopsisUrl" value="/synopsis/edit/${synopsis.bookId}"/>
							<td><a class="btn btn-info" href="${editSynopsisUrl}">Edit</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
